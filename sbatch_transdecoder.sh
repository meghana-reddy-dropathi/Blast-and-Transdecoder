...
#SBATCH --mail-user=dropathi.m@northeastern.edu # Update to your user name!

# Usage: sbatch sbatch_transdecoder.sh
# Assumes input data is in /home/dropathi.m/BINF6308/AiptasiaRNASeq/data/ 
...
cp -r /home/dropathi.m/BINF6308/AiptasiaRNASeq/data/trinity_de_novo data/trinity_de_novo
...
# output files usually start with .transdecoder
...
cp -r results/ /home/dropathi.m/BINF6308/AiptasiaRNASeq/data/proteinPrediction/
